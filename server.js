...
// }
    app.post("/orders/sendRefundEmail/:orderNo", async (req, res) => {
      ...
      const mailOptions = {
        ...
        html: `<p>Dear ${order.customerName},</p>
        <p>We are reaching out to confirm that your refund of $${refundedAmount} for the order #${req.params.orderNo} has been succcessfully processed. Attached to this email, you will fins a copy of the refund receipt for your records.</p>
